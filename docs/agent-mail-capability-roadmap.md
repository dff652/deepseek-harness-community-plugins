...
| P1.2 local candidate | Provider alpha.6 authenticated host and UI 0.1.7 enrollment wizard | [P1.2 acceptance](agent-mail-p12-management-acceptance.md): private opt-in host, login/CSRF/profile ACL, recovery and explicit restart; exact artifact and real DSH gates recorded separately |
