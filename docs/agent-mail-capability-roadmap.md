...
| P0 release gate | Primary agent: retain exact 0.1.5 browser acceptance | PASS after fixing claim-row synchronization and freezing the revised digest; standalone/sidebar, normal workspace/visible Quote, actual tab remount and cleanup checked |
